...
|0028|[Find the Index of the first occurrence in a string](https://leetcode.com/problems/find-the-index-of-the-first-occurrence-in-a-string/)| [C](./leetcode-problems/0028-find-the-index-of-the-first-occurrence-in-a-string/c/solution.c)|✅|Easy| `Two Pointers`, `String`, `String Matching`| |
|0029|[Divide Two Integers](https://leetcode.com/problems/divide-two-integers/)| [C](./leetcode-problems/0029-divide-two-integers/c/solution.c)|✅|Medium| `Math`, `Bit Manipulation`| |
|0030|[Substring with Concatenation of All Words](https://leetcode.com/problems/substring-with-concatenation-of-all-words/)| [C](./leetcode-problems/0030-substring-with-concatenation-of-all-words/c/solution.c)|⬜️|Hard| `Hash Table`, `String`, `Sliding Window`| |
